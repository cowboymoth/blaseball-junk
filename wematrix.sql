...
WE_matrix as (
	...
	where 1=1
	group by gee.outs_before_play, gee.bases_before_play, gee.outs_during_inning, gee.base_count, gee.run_diff_extra, gee.inning_extra, gee.top_of_inning
	order by gee.outs_during_inning, gee.base_count, outs, bases, gee.run_diff_extra, gee.inning_extra, gee.top_of_inning
),
